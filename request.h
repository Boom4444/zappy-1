...
** Last update Sat Jul 13 20:05:18 2013 ivan ignatiev
*/
...
typedef t_request_data	*(*t_proto_func_parse)(t_request_type *type,
					       t_user_player *u,
					       t_server *s, t_world *w);
typedef void		(*t_proto_func)(t_request_data *rqd,
					t_server *s, t_world *w);
