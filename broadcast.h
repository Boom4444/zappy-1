...
** Last update Sat Jul 13 18:54:27 2013 ivan ignatiev
*/
...
double	generate_offsets(double offsets[9][3], t_request_data  *rqd,
			 t_user_player *current, t_server *t);
int	broadcast_to(t_user_player *user,
		     t_request_data *rqd, t_server *t);
